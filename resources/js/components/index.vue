<template>
    ...
    <main>
        ...
        <section>
            <slick class="scroll-portfolio"
                ref="slick"
                :options="slickOptionsPortfolio" >
        ...
        <section id="timeline">
            ...
            <div class="tl-item">
                ...
                <div class="tl-bg" style="background-image: url(frontend/img/gallery/4vision-part-1.svg)"></div>
            ...
            <div class="tl-item">
                ...
                <div class="tl-bg" style="background-image: url(frontend/img/gallery/4vision-part-2.svg)"></div>
            ...
            <div class="tl-item">
                ...
                <div class="tl-bg" style="background-image: url(frontend/img/gallery/4vision-part-3.svg)"></div>
            ...
            <div class="tl-item">
                ...
                <div class="tl-bg" style="background-image: url(frontend/img/gallery/4vision-part-4.svg)"></div>
        ...
        <!-- <div class="testimonial-area testimonial-padding section-bg2" data-backgro:und="{{ asset('frontend/img/gallery/section_bg01.png')">
            <div class="container">
